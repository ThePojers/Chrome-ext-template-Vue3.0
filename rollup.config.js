...
export default {
  ...
  plugins: [
    ...
    replace({
      ...
      "process.env.VUE_APP_FIREBASE_APIKEY": JSON.stringify(
        process.env.VUE_APP_FIREBASE_APIKEY,
      ),
      "process.env.VUE_APP_FIREBASE_AUTHDOMAIN": JSON.stringify(
        process.env.VUE_APP_FIREBASE_AUTHDOMAIN,
      ),
      "process.env.VUE_APP_FIREBASE_PROJECTID": JSON.stringify(
        process.env.VUE_APP_FIREBASE_PROJECTID,
      ),
      "process.env.VUE_APP_FIREBASE_STORAGEBUCKET": JSON.stringify(
        process.env.VUE_APP_FIREBASE_STORAGEBUCKET,
      ),
      "process.env.VUE_APP_FIREBASE_MESSAGINGSENDERID": JSON.stringify(
        process.env.VUE_APP_FIREBASE_MESSAGINGSENDERID,
      ),
      "process.env.VUE_APP_FIREBASE_APPID": JSON.stringify(
